...
They use a preset listed in [CMakePresets.json](https://github.com/Frogzalcoatl/connect4/blob/main/CMakePresets.json).
```
...
## Building the Project
Use an android preset listed in [CMakePresets.json](https://github.com/Frogzalcoatl/connect4/blob/main/CMakePresets.json).
