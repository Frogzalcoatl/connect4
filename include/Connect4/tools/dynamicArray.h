...
// This macro expects "arr" to be a struct with properties: count, capacity, and data (a pointer to
// the start of the array). Do while ensures all if else syntax works properly
